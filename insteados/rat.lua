...
start3 = room {
  ...
  ,dsc= "Зубастый гнаться за мной, я не успеть бежать в нора как раньше. Я бежать в какой-то другой нора -- длинный-длинный туннель. Потом ещё один туннель. Потом бежать ещё в один туннель. Потом в ещё один туннель.^Зубатый не оставать, зубатый бежать быстро-быстро."
  ,obj = { vobj("next", '{Дальше}') }
}
start4 = room {
  nam = ""
