  ...
  pxa = {
	...
	phr = {
		...
		{3, false, always = true, [[Ты что-то упоминал. Вроде как ты искал определенных людей для них.]],
						[[Да. Так вот, эти "яйцеголовые"  сделали заказ на поиск одного человека. 
...
block_2 = room {
  ...
  pxa = {
	...
	редко здесь бываю, но все же считаю его домом. С каждой минутой все произошедшие события пугали меня все больше и больше.
