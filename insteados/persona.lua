...
p_dm_depression = obj {
	nam = "depression",
	dsc = "- {Вялотекущая депрессия}^^Необходимо восстановление личности из резервной копии",
...
p_dm_stress = obj {
	...
	act = "'...Я не уверен, что выживу в полете. Может произойти что угодно. Роботы перепутают провода, или начнут отрывать друг другу конечности...'",
}
