...
ending = room {
	...
	следующий робот проведет свои вахту без серьезных происшествий. Затем сигнал пропадает.
	А на лице мужчины, спящего в капсуле, появляется спокойная улыбка.^^]] .. txtc("КОНЕЦ")
}
