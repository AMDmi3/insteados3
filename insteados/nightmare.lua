  ...
  ,use = function(s,v)
    ...
    elseif v == takeflower and takeflower._take == 1 then
      ...
      if s._cut and vase._water then
        str = str.."^Кажется, цветам это пошло на пользу. Вот значит зачистить контакты! Пип-пип! Что ж, я всё сделал. Теперь нужно пригласить людей по коммуникатору. Пип-пип!";
      end
      return str;
    end
   end
...
endgame2 = room {
  ...
  ,dsc = "Кстати, а где моя правая рука? Пип?^^"..txtc("КОНЕЦ")
}