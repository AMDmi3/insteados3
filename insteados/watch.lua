...
act=function() if main._hand then return "Надеюсь, он не сильно расстроится, когда увидит, что у него нет правой руки." else return "Спать ему ещё целую сотню лет." end end
}
...
cnd=function() return not main._hand end
}

endgame1=room{
nam="",enter=function(s)
if not main._hand then
