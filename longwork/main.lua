...
endgame = room {
   nam = "Конец"
  ,dsc = "Интересно, где бы мне взять исправную ногу?^^"..txtc("КОНЕЦ")
}
