...
main = room {
    ...
    dsc = "WR021 активирован.^Я один из роботов, обслуживающих космический корабль.^Меньше слов, больше выполненых заданий из списка, как говорил наладчик моих модулей индивидуальности.",
